...
const RewritingLearningRessources = () => {
  //Paths
  const rewritingPath = {
    name: "Rewriting",
    path: "/rewriting",
    ...
    <div>
      ...
      <div className="main">
        ...
        <div className="ressources-cards-container">
          <NavLink to="/rewriting/ressources/learning-ressources/books">
            <Ressource
              ressourceTitle="Books"
              description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio, earum."
            />
          </NavLink>
          <NavLink to="/rewriting/ressources/learning-ressources/surveys">
            <Ressource
              ressourceTitle="Surveys"
              description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio, earum."
            />
          </NavLink>
          <NavLink to="/rewriting/ressources/learning-ressources/courses">
            <Ressource
...
export default RewritingLearningRessources;
